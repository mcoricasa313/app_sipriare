<nav class="border-b border-gray-100 bg-red" style="background-color:#bf0909;color:white">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ '/expedientes' }}" :active="request()->routeIs('expedientes')">
                        Solicitudes
                    </x-jet-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-jet-dropdown align="left" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-jet-dropdown-link href="{{ '/usuarios' }}" :active="request()->routeIs('expedientes')">
                            {{ __('Usuarios') }}
                        </x-jet-dropdown-link>
                        <x-jet-dropdown-link href="{{ '/roles' }}" :active="request()->routeIs('expedientes')">
                            {{ __('Roles') }}
                        </x-jet-dropdown-link>
                        <x-jet-dropdown-link href="{{ '/usuarios' }}" :active="request()->routeIs('expedientes')">
                            {{ __('Configurar Alertas') }}
                        </x-jet-dropdown-link>
                    </x-slot>
