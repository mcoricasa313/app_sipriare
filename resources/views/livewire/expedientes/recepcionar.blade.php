                                        ...
                                        <div class="px-1 py-5 bg-white sm:p-6">
                                            <div class="grid grid-cols-6 gap-6">
                                                ...
                                                <div class="col-span-6">
                                                    ...
                                                    <select wire:model="unidadorganica" class="shadow px-3 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                    ...
                                                    <div class="col-span-6">
                                                        ...
                                                        <br>
                                                        <input type="text" class="shadow px-3 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" id="exampleFormControlInput1" placeholder="Usuario" value="{{ $user->USUARIO}}">
                                                    </div>
                                                    @endforeach
                                                    ...
                                                    <label for="">Cargo</label>
                                                        <br>
                                                        <input type="text" class="shadow px-3 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" id="exampleFormControlInput1" placeholder="Usuario" value="{{ $user->US_CARGO}}">
                                                    </div>
                                                    ...
                                                    <div class="col-span-6">
                                                        ...
                                                        <br>
                                                        <input type="text" class="shadow px-3 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" id="exampleFormControlInput1" placeholder="Correo Electronico" value="{{ $user->CORREO}}">
                                                    </div>

                                                    <div class="col-span-6">
                                                        <label for="">Celular</label>
                                                        <br>
                                                        <input type="number" class="shadow px-3 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" id="exampleFormControlInput1" placeholder="Celular" value="{{ $user->CELULAR}}">
                                                    </div>
                                                ...
                                                <div class="col-span-3">
                                                    ...
                                                    <br>
                                                    <select class="shadow px-3 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                        <option value="" selected disabled>-- Seleccionar un prioridad --</option>
                                                ...
                                                <div class="col-span-6">
                                                    ...
                                                    <br>
                                                    <input type="text" class="shadow px-3 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" id="exampleFormControlInput1" placeholder="Instrucciones" >
